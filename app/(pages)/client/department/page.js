...
const Department = () => {
  ...
  const handleEdit = async (updatedData) => {
    try {
      const response = await axios.put(`/api/employee/department/${updatedData._id}`, updatedData);
            ...
            <Table className="shadow-md rounded-lg border-separate">
              <TableHeader>
                <TableRow className="bg-foreground text-left">
                  ...
                  <TableHead className="px-4 py-2 font-semibold text-white">Department Description</TableHead>
              ...
              <TableBody>
                {data.map(single => (
                  <TableRow key={single._id} className="bg-background shadow-lg rounded-lg border-separate" > 
                    <TableCell className="px-4">{single.department}</TableCell>
                    <TableCell className="px-4">{single.department_description}</TableCell>
                    <TableCell>
