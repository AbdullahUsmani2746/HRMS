...
const HelpdeskDashboard = () => {
    const stats = [
        ...
        { title: "Resolved Complaints", value: Math.floor(Math.random() * 40), icon: <FaThumbsUp className="text-purple-500 text-3xl" />, color: "text-purple-600" },
        { title: "Rejected Complaints", value: Math.floor(Math.random() * 20), icon: <FaTimesCircle className="text-red-500 text-3xl" />, color: "text-red-600" },
    ];
