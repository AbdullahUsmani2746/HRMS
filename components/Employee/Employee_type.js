...
const EmployeeTypeComponent = ({ existingData = null, onClose }) => {
  ...
  const [data, setData] = useState([{ employee_type: '', employee_type_description: '', employerId: employerId }]);
  ...
  const addData = () => {
    setData([...data, { employee_type: '', employee_type_description: '', employerId: employerId }]);
  };
