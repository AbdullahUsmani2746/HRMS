...
const PayScheduleComponent = ({ existingData = null, onClose }) => {
  const [data, setData] = useState([{ pay_schedule: '', pay_schedule_description: '', employerId:'CLIENT-001' }]);
  ...
  const addData = () => {
    setData([...data, { pay_schedule: '', pay_schedule_description: '', employerId:'CLIENT-001' }]);
  };
