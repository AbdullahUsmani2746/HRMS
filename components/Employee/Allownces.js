...
const AllowceComponet = ({ existingData = null, onClose }) => {
  ...
  const [data, setData] = useState([{ allownce: '', allownce_description: '', allownce_rate:'',employerId:employerId }]);
  ...
  const addData = () => {
    setData([...data, { allownce: '', allownce_description: '', allownce_rate:'', employerId:employerId }]);
  };
