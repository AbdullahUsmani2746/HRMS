...
const DepartmentComponent = ({ existingData = null, onClose }) => {
  ...
  const [data, setData] = useState([{ department: '', department_description: '', employerId:employerId }]);
  ...
  const addData = () => {
    setData([...data, { department: '', department_description: '', employerId:employerId }]);
  };
